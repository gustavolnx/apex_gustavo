...
<body>
    ...
    <div class="sector" style="width:900px;line-height:30px;">
        ...
        <div class="chevron">
            <img style="height:20px;margin-bottom:-3px;"src=" ../../chevron.png">
        </div>
        <div style="font-size:30px;">
            GERAL
        </div>
    </div>
    <a href="./index.php" class="btn btn1">
        <img src="../../../../sector-ico1.png">
        <div class="text">MEIA CANA</div>
    </a>
    <a href="./index2.php" class="btn btn2">
        <img src="../../../../sector-ico2.png">
        <div class="text">GROSA</div>
    </a>
    <a href="./index3.php" class="btn btn4 active">
